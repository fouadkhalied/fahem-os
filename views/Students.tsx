...
import { STUDENTS, MOCK_TEACHERS, MOCK_ADMINS, CLASSES } from '../services/mockData';
                  ...
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-400 overflow-hidden">
                        {student.id.startsWith('ST-2023') ? <User size={20} /> : <span className="font-bold text-gray-600">{student.name.charAt(0)}</span>}
                      </div>
                      <div>
                  ...
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-3">
                      <div className="w-20 bg-gray-100 rounded-full h-2">
                        <div 
                          className={`h-2 rounded-full ${student.attendance > 90 ? 'bg-green-500' : 'bg-yellow-500'}`} 
